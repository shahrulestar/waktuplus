    ...
    >
      <div ref={anchorRef} className="w-full">
        <ComboboxInput
          ...
          className={cn(
            "w-full h-[47px] min-h-[47px] rounded-lg border bg-[#27272a] border-[#3f3f46] text-white",
            "placeholder:text-zinc-400 [&_input]:text-white [&_input]:bg-transparent [&_input]:text-sm [&_input]:font-medium",
