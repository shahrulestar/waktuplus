  ...
  return (
    ...
    >
      <div style={{ maxWidth: "448px", width: "100%", margin: "0 auto" }}>
        <h1 style={{ fontSize: "28px", fontWeight: 700, color: "#ffffff", margin: "0 0 8px 0", textAlign: "center" }}>
          Waktu+
        </h1>
          ...
          {links.map((link) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <h2 style={{ fontSize: "16px", fontWeight: 600, color: "#ffffff", margin: "0 0 4px 0" }}>
                    {link.label}
                  </h2>
